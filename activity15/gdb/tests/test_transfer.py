...
class TestTransfer(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.acc1 = AccountFactory.create_account(
            "SAVINGS", 1001, "Rajesh Sharma", 30, 100000.0, 0
        )

        self.acc2 = AccountFactory.create_account(
            "SAVINGS", 1002, "Priya Patel", 28, 20000.0, 0
        )
    ...
    def test_remaining_limit(self):
        ...
        self.assertEqual(
            self.acc1.get_remaining_daily_transfer_limit(),
            40000.0
        )
